package com.infosys.ipts.controller;
...
public class InputParameterController {
	...
	public ResponseEntity<Map<String, Integer>> addInputParameter(@RequestBody InputParameters inputParameters) {
		Map<String, Integer> valueToSend = new HashMap<>();
		valueToSend.put("paramId", inputParameterServiceImpl.add(inputParameters));
